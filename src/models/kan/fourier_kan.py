...
class FourierKANLayer(nn.Module):
    def __init__( self, inputdim, outdim, grid_size=5, addbias=True):
        ...
        self.fouriercoeffs = torch.nn.Parameter(torch.randn(2,outdim,inputdim,grid_size) / 
    ...
    def forward(self,x):
        ...
        xrshp = torch.reshape(x, (xshp[0] ,1 ,xshp[1] ,1))
        ...
        '''
        c = torch.reshape(c, (1, xshp[0], xshp[1], self.gridsize))
        s = torch.reshape(s, (1, xshp[0], xshp[1], self.gridsize))
