...
def main() -> None:    
    ...
    lines.append(
        'Generated by `scripts/tabulate_params.py`. Values are total '
    ...
    for act_key in act_keys:
        ...
        for pe_key in pe_keys:
            ...
            b = inr_bench_baseline(cell_key)
            if b is not None:
                baselines_in_row.append(b)
        best = max(baselines_in_row) if baselines_in_row else None
